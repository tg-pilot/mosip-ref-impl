...
import io.mosip.kernel.smsserviceprovider.fast2sms.constant.SmsExceptionConstant;
...
public class SMSServiceProviderImpl implements SMSServiceProvider {
	...
	@Value("${mosip.kernel.sms.language}")
	String language;
	...
	public SMSResponseDto sendSms(String contactNumber, String message) {
		...
		validateInput(contactNumber);
				...
				.queryParam(SmsPropertyConstant.NUMBER.getProperty(), contactNumber)
